(function () {
    ...
    class ShopPanel extends ui.StartSceneUI {
        ...
        readConfigFile() {
            let xmlDom = Laya.loader.load("res/CharactersSkinXml.xml", null, null, Laya.Loader.XML);
